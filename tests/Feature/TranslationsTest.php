 ...
 * a string added to a Custom Assets screen without a translation would
 * sit in English in sixteen languages and nothing anywhere would say so.
 * That is exactly what happened before these catalogues existed: of the
 * twenty-five strings this module uses, thirteen were translated only
 * because the host happened to use the same word, and twelve were not
 * translated at all.
 */
